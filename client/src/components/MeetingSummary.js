...
const MeetingSummary = () => {
  ...
  const startEditing = async () => {
    setActionError('');
    try {
      if (isEducation && meeting?.educationSummaryTeacherReviewedAt) {
        setSaving(true);
        await axios.put(
        ...
        <div className="meeting-summary-card">
          ...
          {!meeting.editorVerificationRequired &&
            ...
            <MeetingSummaryReadonlyBody
              ...
              readOnlyEducationAssignments={isEducation && canEditAndSend}
          ...
          {meeting.editorVerificationRequired && (
            ...
            >
              ...
              <p className="meeting-summary-body">
                ...
                {isEducation ? 'the class.' : 'participants.'}
              </p>
